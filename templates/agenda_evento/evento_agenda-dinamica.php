...
<div class="container" style="margin-top: .5em">
	...
	<?php foreach( $agendas as $agenda ): ?>
		...
		<?php 
			...
			if($agenda->hora_inicio > '14:59:00'){
				$i++;	
			}	

		?>

		<?php if($i==1 && (is_single(3220) || is_single(3223) || is_single(5233)) ): ?>
		<div class="row">
			<div class="col-xs-6"><img style="margin-top: 1.5em;margin-bottom: -1.8em" src=" <?php echo bloginfo('template_url') ?>/img/summit_valores.png " alt="" class="img-responsive"></div>
		</div>
		<?php endif; ?>
	...
	<div class="row agenda_botones">
		...
		<div class="col-sm-12 col-md-6">
			...
			<script>
				...
				var pfCustomCSS = 'https://laneurona.com/wp-content/themes/la_neurona_20/css/printpdf.css';
				var pfBtVersion='2';
				(function(){
						var js,pf;
