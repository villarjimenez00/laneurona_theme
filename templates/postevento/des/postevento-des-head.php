	...
	<div class="row vertical-align">
		...
		<div class="col-sm-12 col-md-6 header-left">
			...
			<div class="row header-left-row" style="">
					...
					<h1 style="color: #ffffff;">Participamos en una de las mayores citas mundiales sobre transformación digital</h1>
					<h3 class="dorado">La Feria, celebrada el 21, 22 y 23 de mayo en Madrid, congregó a 25.000 asistentes y La Neurona formó parte de ella.</h3>
